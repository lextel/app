...
public class InstallUtils {
    ...
    public static final int install(Context context, String filePath) {
        if (InstallUtils.isSystemApplication(context) || checkRootPermission()) {
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        CommandResult commandResult = execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static int getInstallLocation() {
        CommandResult commandResult = execCommand("LD_LIBRARY_PATH=/vendor/lib:/system/lib pm get-install-location",
                                                             false, true);
